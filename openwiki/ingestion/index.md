...
- [Corpus Triage and Document Parsing](document-parsing.md) - How a folder of files becomes ParsedDoc objects — enumeration and classification, the layered Docling/pdfminer/pdfplumber extraction chain, (cid:NNN) font-mapping failure detection with its re-extraction attempt, and how parse_confidence is computed and penalized.
